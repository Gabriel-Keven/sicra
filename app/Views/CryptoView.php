                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="cardFirstCreatePairOfKeys" class="d-none">
                            ...
                            <button type="button" class="mt-3 btn btn-success btn-block" id="firstPairKeysButton">Criar Par de Chaves</button>
                            </div>
                            <div id="cardCreateNewPairOfKeys" class="d-none">
                                ...
                                <button type="button" class="mt-3 btn btn-primary btn-block" id="NewPairKeysButton">Criar Novo Par de Chaves</button>
                            </div>
                            <div id="cardDeletePairOfKeys" class="mt-3">
                                ...
                                <button type="button" class="mt-3 btn btn-danger btn-block" id="deletePairKeysButton">Deletar Atual Par de Chaves</button>
                            </div>
                        <form>
                            ...
                            <!-- <button type="submit" class="mt-3 btn btn-primary btn-block" id="sendButton">Enviar</button> -->
                        </form>
                    </div>
                </div>
            </div>
